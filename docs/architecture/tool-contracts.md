...
GigFinderAgent has twelve read tools and five mutation tools.
...
Gig and Person tools use structurally strict operation lists. Field and value
...
Successful Gig and Person updates return the persisted record and change ID.
