...
import { ScoutPositionReview } from "./ScoutPositionReview";
type Run = {
  id: string;
  status: string;
  createdAt: string;
...
export function GigScoutPage({
  ...
  return <section className="scout-page" aria-labelledby="scout-workspace-title">
    <div className="scout-heading"><div><p className="eyebrow">Official career sources</p><h2 id="scout-workspace-title">Gig Scout</h2></div></div>
    <nav aria-label="Gig Scout views">
