...
import { EntityUpdateService } from "./entity-updates";

/** Application API shared by the web server, CLI, and automation. */
export class JobSearchApplication {
  readonly jobs:JobDomainService;readonly people:PeopleService;readonly networking:ContactDomainService;readonly tasks:TaskDomainService;readonly meetings:MeetingService;readonly jobPeople:JobPeopleService;readonly events:EventService;readonly history:HistoryService;readonly artifacts:ArtifactDomainService;readonly agentContext:JobSearchAgentContext;readonly updates:EntityUpdateService;
  constructor(persistence:Persistence,audit:AuditPort,artifacts:ArtifactPort){
    ...
    this.updates=new EntityUpdateService(persistence,this.jobs,this.networking);
  }
}
