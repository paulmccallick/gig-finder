...
import { JobSearchMutationService } from "./agent-mutations";

/** Application API shared by the web server, CLI, and automation. */
export class JobSearchApplication {
  readonly jobs:JobDomainService;readonly people:PeopleService;readonly networking:ContactDomainService;readonly tasks:TaskDomainService;readonly meetings:MeetingService;readonly jobPeople:JobPeopleService;readonly events:EventService;readonly history:HistoryService;readonly artifacts:ArtifactDomainService;readonly agentContext:JobSearchAgentContext;readonly agentMutations:JobSearchMutationService;
  constructor(persistence:Persistence,audit:AuditPort,artifacts:ArtifactPort){
    ...
    this.agentMutations=new JobSearchMutationService(persistence,this.jobs,this.networking);
  }
}
