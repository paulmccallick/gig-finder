...
- Development
  ...
  - All changes are comitted
  - `release-verifier` is asked to verify the changes
  - change overview agent is run against the changes with overview captured in an md file immediately upon pr creation.
